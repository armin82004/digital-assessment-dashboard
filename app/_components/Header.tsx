...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b-2 border-b-neutral-300 dark:border-b-neutral-600 bg-blue-500 backdrop-blur-sm p-3 flex justify-between items-center">
